...
```json
{"evidence_id":"...","source_type":"c2pa|exif|metadata|frequency|noise|artifact|model","detector_version":"...","timestamp":"RFC3339 UTC","input_hash":"SHA-256","reliability":"declared method reliability","observation":{},"limitation":"..."}
```
